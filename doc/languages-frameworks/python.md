...
pyfftw = buildPythonPackage rec {
  ...
  LDFLAGS="-L${pkgs.fftw.dev}/lib -L${pkgs.fftwFloat}/lib -L${pkgs.fftwLongDouble}/lib"
  CFLAGS="-I${pkgs.fftw.dev}/include -I${pkgs.fftwFloat}/include -I${pkgs.fftwLongDouble}/include"
  '';
