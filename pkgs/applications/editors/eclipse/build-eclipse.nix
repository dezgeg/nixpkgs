...
stdenv.mkDerivation rec {
  ...
  buildCommand = ''
    ...
    [ -f $libCairo ] && patchelf --set-rpath ${freetype.dev}/lib:${fontconfig.dev}/lib:${libX11.dev}/lib:${libXrender.dev}/lib:${zlib.dev}/lib $libCairo
    ...
    makeWrapper $out/eclipse/eclipse $out/bin/eclipse \
      --prefix PATH : ${jdk}/bin \
      --prefix LD_LIBRARY_PATH : ${glib.dev}/lib:${gtk.dev}/lib:${libXtst}/lib${stdenv.lib.optionalString (webkitgtk2 != null) ":${webkitgtk2}/lib"} \
