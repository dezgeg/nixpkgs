...
in stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    my_patchelf \
      ...
      --set-rpath ${cups.dev}/lib:$(cat $NIX_CC/nix-support/orig-cc)/lib:${stdenv.glibc}/lib \
    ...
    my_patchelf \
      --set-rpath $(cat $NIX_CC/nix-support/orig-cc)/lib:${stdenv.glibc}/lib:${libusb.dev}/lib:${libxml2}/lib \
